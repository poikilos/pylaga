...
class Points(pygame.sprite.Sprite):
    ...
    def update(self):
        if self.temp != 0:
            ...
            self.pointsimg = self.font.render(str(self.total_points), 0, (255, 255, 255))
            self.pointsrect = self.pointsimg.get_rect()
            self.pointsrect.move_ip(0, self.textrect.height)
            pygame.Surface.blit(self.image, self.pointsimg, self.pointsrect)
            self.temp = 0
    ...
    def draw(self):
        text = self.font.render(self.pointstr + str(self.total_points), 0, (255, 255, 255))
...
class Health(pygame.sprite.Sprite):
    ...
    def update(self):
        if self.temp != 0:
            ...
            self.healthimg = self.font.render(str(self.total_health), 0, (255, 255, 255))
            self.healthrect = self.healthimg.get_rect()
            self.healthrect.move_ip(0, self.textrect.height)
            pygame.Surface.blit(self.image, self.healthimg, self.healthrect)
    ...
    def draw(self):
        text = self.font.render(str(self.total_health), 0, (255, 255, 255))
        globalvars.surface.fill((0, 0, 0), self.rect)
        globalvars.surface.blit(text, (globalvars.points_x, globalvars.points_y))
...
class HealthBar(pygame.sprite.Sprite):
    ...
    def __init__(self, health):
        ...
        pygame.draw.rect(self.image,(255,255,255),pygame.Rect(0,0,self.width,self.total_health))
